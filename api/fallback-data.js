// Server-side mirrors of the marketing preview data. These keep the public
// landing page complete when the optional CMS tables have not been provisioned.
export const FALLBACK_NARRATIVE = {
  ...
  pillars: [
    { id: 1, num: '01', name: 'Performance', line: 'Training that changes when you do.', description: 'Daily readiness, recent load and your long-term goal shape every session before it reaches you.', detail: 'ADAPTIVE TRAINING LOAD', image: '/images/pillar-performance.jpg' },
    { id: 2, num: '02', name: 'Nutrition', line: 'Fuel decisions made before hunger makes them.', description: 'Meals and macros are organized around the work ahead, not isolated from the rest of your day.', detail: 'CONTEXT-AWARE FUEL', image: '/images/pillar-nutrition.jpg' },
    { id: 3, num: '03', name: 'Recovery', line: 'Progress includes knowing when to hold back.', description: 'Sleep, soreness and accumulated fatigue quietly adjust the plan without breaking its direction.', detail: 'READINESS-LED RECOVERY', image: '/images/pillar-recovery.jpg' },
    { id: 4, num: '04', name: 'Progress', line: 'Patterns you can act on, not numbers to collect.', description: 'Calorais turns weeks of training and nutrition into a clear view of what is actually moving you forward.', detail: '12-WEEK SIGNALS', image: '/images/pillar-progress.jpg' },
  ],
  timeline: [
...
export const FALLBACK_DASHBOARD = {
  ...
  activity: [
    { id: 1, day: 'MON', value: 78, workouts: 1 }, { id: 2, day: 'TUE', value: 92, workouts: 1 },
    { id: 3, day: 'WED', value: 64, workouts: 1 }, { id: 4, day: 'THU', value: 0, workouts: 0 },
    { id: 5, day: 'FRI', value: 86, workouts: 1 }, { id: 6, day: 'SAT', value: 72, workouts: 1 },
...
export const FALLBACK_PLANS = [
  { id: 1, name: 'START', price: 0, period: 'forever', description: 'See what a prepared day feels like.', features: ['Daily protocol', 'Training and fuel targets', 'Weekly progress view'], highlighted: false, button_text: 'Start free' },
  { id: 2, name: 'OPERATE', price: 19, period: 'month', description: 'The full system, adapting as you live.', features: ['Everything in Start', 'Adaptive training plans', 'Nutrition photo analysis', 'Recovery-led adjustments', 'Calorais console'], highlighted: true, button_text: 'Begin 14-day trial' },
  { id: 3, name: 'ANNUAL', price: 149, period: 'year', description: 'One year of uninterrupted preparation.', features: ['Everything in Operate', 'Two months included', 'Long-range progress reports', 'Priority access to new tools'], highlighted: false, button_text: 'Choose annual' },
];
